...
export default {
  ...
  methods: {
    i1() {
      this.$createEffect('.instance.i1', $demo => {
        return new JParticles.Waves($demo, {
          num: 3,
          lineColor: [
            'rgba(0, 190, 112, .5)',
            'rgba(0, 190, 112, .7)',
    ...
    i2() {
      this.$createEffect('.instance.i2', $demo => {
        const settings = {
          crestHeight: [10, 14, 18],
          speed: 0.1,
        }

        const effect = new JParticles.Waves(
          $demo,
    ...
    i3() {
      this.$createEffect('.instance.i3', $demo => {
        return new JParticles.Waves($demo, {
          num: 1,
          line: false,
          fill: true,
