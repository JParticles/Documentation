...
(function () {
  var languages = {
    "cn": {
      ...
      "header": {
        ...
        "common": ["首页", "实例及API", "下载", "GitHub", "QQ群", {
          "name": "更新日志",
      ...
      "examples": {
        "required": "必读",
        "menu": ["介绍", "5分钟上手JParticles", "粒子运动", "波浪运动", "波纹模拟进度条", "雪花飘落"]
      }
    },
    "en": {
      ...
      "header": {
        ...
        "common": ["Home", "Examples & API", "Download", "GitHub", "QQ Group", {
          "name": "Changelog",
          "title": "The way ahead is long, I see no ending, yet high and low I will search with my will unbending."
        }]
      },
      "footer": {
        "support": "Support Author(Star on GitHub)"
      },
      "home": {
        "description": "A succinct, efficient and lightweight Canvas library for building some cool particle effects.",
        "seeMore": "see more",
      ...
      "examples": {
        "required": "Required",
        "menu": ["Intro", "Quick Start", "Particles Motion", "Waves Motion", "Wave Loading", "Snow"]
      }
  ...
  for (var key in languages) {
    ...
    lang.languageFlag = "/languages/".concat(lang.languageCode, "/images/flag.png");
  }
