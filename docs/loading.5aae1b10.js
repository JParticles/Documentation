  ...
  var languages = {
    "cn": {
      ...
      "header": {
        ...
        "common": ["首页", "实例及API", "细节API及FAQ", "下载", "GitHub", {
          "name": "更新日志",
      ...
      "examples": {
        "required": "必读",
        "menu": ["5分钟上手JParticles", "粒子运动（Particle）", "波纹运动（Wave）", "波纹进度条（WaveLoading）", "雪花飘落（Snow）", "线条动画（Line）"]
      }
    },
    "en": {
      ...
      "title": "JParticles - concise, lightweight, and efficient Canvas library for building some cool particle effects.",
      "header": {
        "smallScreen": {
          "menu": "Menu"
        },
      ...
      "noData": "Oops... the document is missing",
      "notFound": {
      ...
      "examples": {
        "required": "Required",
        "menu": ["Quick Start", "Particle", "Wave", "WaveLoading", "Snow", "Line"]
      }
    }
  };
